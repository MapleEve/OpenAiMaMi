...
Source evidence root: `raw/aimami/1.2.3/macos-arm64/` (relative to `${C5CM_INTERNAL_HISTORY_ROOT:-$C5CM_SHARE_ROOT}` = `<内部存储>`). Full pointer list in `../pointers/evidence-paths.md`.
