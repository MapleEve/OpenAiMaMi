...
| `06-target-1.1.1.md` | 1.0.9 → 1.1.1 | 版本演进（macOS 43 delta；Windows gate-final 60 delta；plugin/passthrough 下线、relay stream/API login、router diagnostics、mcp/skills/registry/auth/account 子系统变化） | sanitized 1.1.1 delta summaries + gate-final rollups |
...
- [x] `06-target-1.1.1.md` — 公开清洗版：macOS 43/43 readyToImplement，Windows 55/60 readyToImplement + 3 strictImplementationUse + 2 lower（2026-06-20）
