...
| `fetch_relay_models_draft` | `fetch_relay_models_draft_0x140cc9510.c` | 0x140cc9510 | ✅ 完整（54514 chars, IDA Python chunking 恢复） |
...
| `load_quota_history` | `load_quota_history_0x140cdb800.c` | 0x140cdb800 | ✅ 完整（36418 chars, IDA Python chunking 恢复） |
