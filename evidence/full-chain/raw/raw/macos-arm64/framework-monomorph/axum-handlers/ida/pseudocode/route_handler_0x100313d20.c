/* addr=0x100313d20 cleanname=route_handler group=axum-handlers
 * decompiled via IDA Python server-side IDA decompiler.decompile
 * n_lines=415 brace_balanced=True truncation_markers=[]
 */
_QWORD *__fastcall _$LT$F$u20$as$u20$axum..handler..Handler$LT$$LP$M$C$T1$C$T2$C$T3$C$T4$RP$$C$S$GT$$GT$::call::_$u7b$$u7b$closure$u7d$$u7d$::he102bcd2d514dc9c(
        _QWORD *a1,
        __int64 a2,
        void *a3,
        __int64 a4,
...
LABEL_53:
        ...
        *(_QWORD *)(a2 + 1216) = "routerlocal compact compatibility responseno relay provider configured for codexall codex relay providers failed; please check provider config / networkgpt-image-2";
        *(_QWORD *)(a2 + 1224) = 6;
        *(_QWORD *)(a2 + 1232) = v51;
        *(_QWORD *)(a2 + 1240) = a5;
        *(_WORD *)(a2 + 1776) = 0;
      ...
      *(_QWORD *)&v77 = a2 + 4448;
      ...
      switch ( *(_BYTE *)(a2 + 4448) )
      {
        case 0:
          goto LABEL_50;
        case 1:
          core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_10195D768);
        case 2:
          core::panicking::panic_const::panic_const_async_fn_resumed_panic::h51796ee0ce4d776a(&off_10195D768);
        case 3:
          goto LABEL_58;
      }
  }
