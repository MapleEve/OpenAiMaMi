...
__int64 __fastcall sub_14089DF20(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r13
  ...
  _BYTE v28[1036]; // [rsp+BCh] [rbp+3Ch] BYREF
  __int64 v29; // [rsp+4C8h] [rbp+448h]
  volatile signed __int64 *v30; // [rsp+4D8h] [rbp+458h]
  __int64 v31; // [rsp+4E0h] [rbp+460h]
  _QWORD v32[137]; // [rsp+528h] [rbp+4A8h] BYREF
  ...
  sub_141684120((char *)v32 + 4, a3, 1016);
  v20 = 204;
  v21 = nullptr;
  v22 = &off_1417BD028;
  v23 = 0;
