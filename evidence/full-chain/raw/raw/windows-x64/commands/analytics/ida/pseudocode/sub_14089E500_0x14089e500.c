...
__int64 __fastcall sub_14089E500(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r13
  ...
  _BYTE v28[1012]; // [rsp+BCh] [rbp+3Ch] BYREF
  __int64 v29; // [rsp+4B0h] [rbp+430h]
  volatile signed __int64 *v30; // [rsp+4C0h] [rbp+440h]
  __int64 v31; // [rsp+4C8h] [rbp+448h]
  _QWORD v32[134]; // [rsp+540h] [rbp+4C0h] BYREF
  ...
  sub_141684120((char *)v32 + 4, a3, 992);
  v20 = 204;
  v21 = nullptr;
  v22 = &off_1417BD0C8;
  v23 = 0;
