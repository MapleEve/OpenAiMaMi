...
__int64 __fastcall sub_14089BEE0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r13
  ...
  _BYTE v28[196]; // [rsp+BCh] [rbp+3Ch] BYREF
  __int64 v29; // [rsp+180h] [rbp+100h]
  volatile signed __int64 *v30; // [rsp+190h] [rbp+110h]
  __int64 v31; // [rsp+198h] [rbp+118h]
  _QWORD v32[32]; // [rsp+270h] [rbp+1F0h] BYREF
  ...
  sub_141684120((char *)v32 + 4, a3, 176);
  v20 = 204;
  v21 = nullptr;
  v22 = &off_1417BCCB8;
  v23 = 0;
  ...
  v26 = v9;
  v27 = 0;
  sub_141684120(v28, v32, 180);
  *(_OWORD *)&v28[180] = 0;
  v29 = 0;
  v30 = v12;
  v31 = v4;
  nullsub_1(v13);
  v14 = sub_140001650(384, 128);
  if ( !v14 )
    sub_1416C2D31(128, 384);
  v15 = v14;
  sub_141684120(v14, &v20, 384);
  LOBYTE(v16) = 1;
