...
_QWORD *__fastcall sub_140B064D0(_QWORD *a1, _QWORD *a2)
{
  _BYTE *v4; // rax
  __int64 v5; // rdi
  _QWORD *v6; // rcx
  ...
  *v4 = 123;
  ...
  v14 = 256;
  v15 = &v10;
  v5 = sub_140467220(&v14, aSchemaversion_5, 13, a2 + 111);
  if ( v5 )
    goto LABEL_6;
  if ( (_BYTE)v14 )
    goto LABEL_4;
  v5 = sub_140466A30(&v14, aSuccess_0, 7, (char *)v16 + 892);
  if ( v5 )
    goto LABEL_6;
  if ( (_BYTE)v14 )
    goto LABEL_4;
  v5 = sub_14045E240(&v14, aCode_8, 4, v16 + 102, v10);
  if ( v5 )
    goto LABEL_6;
  if ( (_BYTE)v14 )
  {
LABEL_4:
  ...
  v5 = sub_14045E240(&v14, aMessage_3, 7, v16 + 105, v10);
  if ( v5 || (v5 = sub_140ABBD30(&v14, (__int64)(v16 + 108))) != 0 || (v5 = sub_140ABC1F0(&v14, v16)) != 0 )
  {
LABEL_6:
    if ( v11 )
