...
// addr: 0x14016e5c0
// name: load_voice_asr_config
// win 1.2.1 | tauri command handler = load_voice_asr_config | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall load_voice_asr_config(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // r14
  __int64 v4; // r15
