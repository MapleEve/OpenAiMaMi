...
// addr: 0x14018aa10
// name: dismiss_pending_auto_switch
// win 1.2.1 | tauri command handler = dismiss_pending_auto_switch | mapped via command-name string xref (win-native, ground-truth)
