...
// addr: 0x14018a480
// name: get_device_id
// win 1.2.1 | tauri command handler = get_device_id | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall get_device_id(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rcx
  __int64 v4; // r14
