...
// win 1.2.1 | tauri command handler = stop_voice_capture | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall stop_voice_capture(__int64 a1)
{
  __int64 v2; // rsi
  __int64 v3; // rbx
  __int64 v4; // r14
