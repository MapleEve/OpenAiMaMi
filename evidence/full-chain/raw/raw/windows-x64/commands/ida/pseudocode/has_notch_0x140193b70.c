...
// addr: 0x140193b70
// name: has_notch
// win 1.2.1 | tauri command handler = has_notch | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall has_notch(__int64 a1)
{
  ...
  if ( v22 != -1 )
  {
    ...
    v36 = 1;
    sub_140970DA0(&v27, v16);
    sub_141684120(v21, a1 + 520, 400);
    v3 = v27;
    if ( v27 == -1 )
    {
      LOWORD(v22) = __PAIR16__(v28, -1);
LABEL_13:
      v35 = 0;
      sub_14043A590(v21, &v22);
      goto LABEL_14;
    }
    v4 = v28;
    if ( v28 < 0 )
