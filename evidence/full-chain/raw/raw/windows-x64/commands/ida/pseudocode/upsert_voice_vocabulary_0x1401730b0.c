...
// addr: 0x1401730b0
// name: upsert_voice_vocabulary
// win 1.2.1 | tauri command handler = upsert_voice_vocabulary | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall upsert_voice_vocabulary(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // r14
  __int8 v4; // bl
  ...
  v33 = &v41;
  v53 = 1;
  v2 = sub_140003640((volatile void *)(v9 + 16));
  v3 = v2;
  if ( v2 )
  {
    v35.m256i_i64[1] = v2;
  ...
  {
    v53 = 1;
    sub_1416850A0(&v35, &v28, &v30);
    if ( v35.m256i_i8[0] != -1 )
    {
      v19 = v35;
      sub_141684120(&v28, a1 + 520, 360);
      v10 = *(_OWORD *)(a1 + 880);
      v11 = *(_QWORD *)(a1 + 896);
      v18 = 1;
      v53 = 0;
      sub_14047E370((unsigned int)&v28, v15, (unsigned int)&v18, (unsigned int)&v10, v16, v17);
      goto LABEL_23;
    }
    v3 = v35.m256i_i64[1];
  }
        ...
        if ( v22.m256i_i8[0] == -1 )
        {
          ...
          if ( v24.m256i_i8[0] == -1 )
          {
            ...
            if ( v23.m256i_i8[0] == -1 )
            {
              ...
              v32 = v8;
              v33 = &v41;
              sub_140973410(&v37, &v28);
              LOBYTE(v51) = v37.m256i_i8[0];
              if ( v37.m256i_i8[0] == -1 )
              {
                v21 = v37.m256i_i64[3];
                v20 = *(_OWORD *)&v37.m256i_u64[1];
                sub_1407584D0(&v10, v3, &v49, &v47, &v45, v4, &v43, &v39, &v20);
                sub_141684120(&v28, v12, 400);
                if ( (_QWORD)v10 == -1 )
                {
                  v52 = 1;
                  sub_1401BDB30(&v37, (char *)&v10 + 8);
                  v19 = v37;
                  v18 = -1;
                }
                else
                {
                  sub_141684120(&v18, &v10, 368);
                }
                v52 = 0;
                sub_140435D40(&v28, &v18);
                goto LABEL_23;
              }
              v19 = v37;
              sub_141684120(&v28, v12, 360);
              v10 = v13;
              v11 = v14;
              v18 = 1;
              sub_14047E370((unsigned int)&v28, v15, (unsigned int)&v18, (unsigned int)&v10, v16, v17);
