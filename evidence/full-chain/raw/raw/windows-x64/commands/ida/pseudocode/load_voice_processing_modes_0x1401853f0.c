...
// addr: 0x1401853f0
// name: load_voice_processing_modes
// win 1.2.1 | tauri command handler = load_voice_processing_modes | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall load_voice_processing_modes(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rcx
  __int64 v4; // rdx
...
LABEL_13:
  ...
  *(_QWORD *)v31 = 1;
  v43 = 0;
  sub_14047E370((unsigned int)v22, v19, (unsigned int)v31, (unsigned int)&v24, v20, v21);
LABEL_15:
  if ( (_QWORD)v38 != -1 )
  {
    v12 = *((_QWORD *)&v38 + 1);
