...
// addr: 0x1401744e0
// name: remove_voice_template
// win 1.2.1 | tauri command handler = remove_voice_template | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall remove_voice_template(__int64 a1)
{
  __int64 v2; // r14
  __int64 v3; // rcx
  __int64 v4; // r14
