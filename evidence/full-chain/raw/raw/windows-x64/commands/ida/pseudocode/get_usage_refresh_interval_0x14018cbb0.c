...
// addr: 0x14018cbb0
// name: get_usage_refresh_interval
// win 1.2.1 | tauri command handler = get_usage_refresh_interval | mapped via command-name string xref (win-native, ground-truth)
