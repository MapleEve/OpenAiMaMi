...
__int64 __fastcall sub_1402C5ED0(_QWORD *a1)
{
  __int64 v2; // rdx
  __int64 result; // rax
  __int64 v4; // rdx
  ...
  v8 = a1[17];
  if ( v8 != -1 && v8 )
    result = sub_140001660(a1[18], v8, 1);
  v9 = a1[20];
  if ( v9 != -1 && v9 )
    result = sub_140001660(a1[21], v9, 1);
  v10 = a1[23];
  if ( v10 != -1 && v10 )
    result = sub_140001660(a1[24], v10, 1);
  v11 = a1[26];
  if ( v11 != -1 && v11 )
    result = sub_140001660(a1[27], v11, 1);
  v12 = a1[29];
  if ( v12 != -1 )
  {
    if ( v12 )
      result = sub_140001660(a1[30], v12, 1);
    v13 = a1[32];
    if ( v13 )
      result = sub_140001660(a1[33], v13, 1);
    v14 = a1[35];
    if ( v14 != -1 )
    {
      if ( v14 )
        return sub_140001660(a1[36], v14, 1);
    }
  }
  return result;
}