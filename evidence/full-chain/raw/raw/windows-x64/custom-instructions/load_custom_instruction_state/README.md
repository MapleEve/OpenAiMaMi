...
- `func_query name_regex=load_custom_instruction_state` (Hex-Rays symbol table) -> 0 hits.
- `find_regex pattern=load_custom_instruction_state` (string pool) -> 0 hits.
