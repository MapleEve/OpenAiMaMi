# AI Handoff — apply_custom_instruction (windows AiMaMi 1.2.3 custom-instructions)

status: accepted_ready_absent_backend_orphan_ida_direct (migrated_no_behavior_diff)
evidence_root: raw/aimami/1.2.3/windows-x64/custom-instructions/apply_custom_instruction/
...
scripts: tools/IDA CLI win func_query '{"queries":[{"name_regex":"apply_custom_instruction"}]}'; tools/IDA CLI win find_regex '{"pattern":"apply_custom_instruction"}'
