# AI Handoff — preview_custom_instruction_apply (windows AiMaMi 1.2.3 custom-instructions)

status: accepted_ready_absent_backend_orphan_ida_direct (migrated_no_behavior_diff)
evidence_root: raw/aimami/1.2.3/windows-x64/custom-instructions/preview_custom_instruction_apply/
