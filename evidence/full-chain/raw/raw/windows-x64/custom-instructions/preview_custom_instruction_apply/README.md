...
- `func_query name_regex=preview_custom_instruction_apply` (Hex-Rays symbol table) -> 0 hits.
- `find_regex pattern=preview_custom_instruction_apply` (string pool) -> 0 hits.
