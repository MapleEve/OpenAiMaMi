# System Diff — preview_custom_instruction_apply (windows AiMaMi 1.0.9 -> 1.2.3)
...
No diff. Command name, wrapper shape and argKeys=['content'] byte-identical between 1.0.9 and 1.2.3 windows ipc-contracts.jsonl.
