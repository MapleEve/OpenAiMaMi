...
__int64 __fastcall sub_140A1F800(__int64 a1, __int64 a2)
{
...
LABEL_20:
  v28 = v2;
  v22 = sub_140A6C2D0("claude-3-7claude-opus-4claude-sonnet-4claude-haiku-4-5web_search_20250305", 0xAu, v6, v2);
  LOBYTE(v2) = 1;
  if ( !v22 && !sub_140A6C2D0("claude-opus-4claude-sonnet-4claude-haiku-4-5web_search_20250305", 0xDu, v6, v28) )
  {
    v23 = sub_140A6C2D0("claude-sonnet-4claude-haiku-4-5web_search_20250305", 0xFu, v6, v28);
    v24 = v28;
    v25 = v6;
    if ( v23 )
      goto LABEL_25;
    LOBYTE(v26) = sub_140A6C2D0("claude-haiku-4-5web_search_20250305", 0x10u, v6, v28);
    LODWORD(v2) = v26;
  }
  v24 = v28;
  v25 = v6;
