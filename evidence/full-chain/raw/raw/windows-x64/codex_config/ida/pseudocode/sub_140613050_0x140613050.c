...
__int64 *__fastcall sub_140613050(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, _QWORD *a6)
{
  __int64 v6; // rbx
  ...
  __int64 v50; // [rsp+F8h] [rbp+78h]
  __int64 v51; // [rsp+100h] [rbp+80h]
  char v52; // [rsp+10Fh] [rbp+8Fh] BYREF
  ...
  while ( 1 )
  {
    ...
    v53 = v17;
    sub_1404076D0((__int64)&v34 + 8, v17, v7, a6);
    v18 = *((_QWORD *)&v34 + 1);
    v48 = v35;
    v19 = (unsigned __int64)v36;
    if ( v36 == (__int64 (__fastcall *)(_QWORD, _QWORD))v7 && !(unsigned int)sub_1416847B0(v48, v53, v7) )
    {
      *a1 = -1;
      v21 = v53;
      v22 = v54;
