...
// addr: 0x140cbf6f0
// name: confirm_pending_auto_switch
// win 1.2.1 | module src/lib.rs | attributed via panic-Location xref (win-native)
// win 1.2.1 | tauri command handler = confirm_pending_auto_switch | mapped via command-name string xref (win-native, ground-truth)
char __fastcall confirm_pending_auto_switch(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // r13
  __int64 v6; // rax
  __int64 v7; // rsi
...
LABEL_9:
        ...
        case 1:
LABEL_55:
          JUMPOUT(0x140CC0071LL);
        case 2:
LABEL_52:
          v70 = v20;
          sub_1416C3420(&off_1417BB258, v18, a3, a4);
        case 3:
          break;
      }
LABEL_10:
