...
__int64 *__fastcall sub_1408339A0(_QWORD *a1, __int64 *a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rax
  char v6; // bl
  int v7; // eax
  ...
  switch ( *((_BYTE *)a2 + 208) )
  {
    case 0:
      ...
      *((_BYTE *)a2 + 88) = 0;
      break;
    case 1:
      sub_1416C3400(&off_141795A28, a2, a3, a4);
    case 2:
      sub_1416C3420(&off_141795A28, a2, a3, a4);
    case 3:
      break;
  }
  sub_1408323C0(a1, a2 + 1, a3, a4);
  v6 = 3;
  if ( *a1 != -2 )
  {
