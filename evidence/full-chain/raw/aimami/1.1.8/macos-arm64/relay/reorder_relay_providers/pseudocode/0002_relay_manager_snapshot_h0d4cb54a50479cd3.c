// addr=0x1005cdf60
// depth 2 (sibling of persist) — takes a Mutex-guarded Clone of RelayState. Called from RelayManager::reorder AND from sync_codex_config_with_outcome (shared helper).
