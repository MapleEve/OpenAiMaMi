// addr=0x1004b14b0
// depth 2 — deep-clones the RelayState struct and rebuilds the provider Vec, used to build the exact bytes returned as the command's Ok response payload (masks/reshapes fields before handing state back across the IPC boundary).
