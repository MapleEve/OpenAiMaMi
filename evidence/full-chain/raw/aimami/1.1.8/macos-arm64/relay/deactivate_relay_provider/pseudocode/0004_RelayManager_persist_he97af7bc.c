// codexmate_lib::core::relay::manager::RelayManager::persist::he97af7bc6e4923b9
addr: 0x1005cccf0
role: recomputes proxyStatus via compose_proxy_status, calls storage::save (0x1004b2680, ALREADY FULLY LEAFED in raw/aimami/1.1.8/macos-arm64/relay/load_relay_state/pseudocode/0004_storage_save_h4619a271_FULL.c) to write relay.json, then updates the in-process mutex-guarded RelayState cache (drop old + memmove new), returns discriminant=10 to signal caller to proceed to sync_codex_config_with_outcome
0-truncation full decompile
// --- refs ---
// ref: 0x101130a02 _memcpy
// ref: 0x1005c1380 __ZN13codexmate_lib4core5relay7manager12RelayManager20compose_proxy_status17h3638a0ee22531e27E
// ref: 0x100001440 __RNvCs1Y7DaGC1cwg_7___rustc14___rust_dealloc
// ref: 0x1004b2680 __ZN13codexmate_lib4core5relay7storage4save17h4619a27159e38d20E
