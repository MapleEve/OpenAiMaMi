// mac 1.1.8 BEHAVIORAL-BACKEND request_existing_instance_activation_with_url node 0x101129ca0 depth=6
...
{
  std::alloc::rust_oom::h1eabbce9e7329b36(a2, a1); /*0x101129cad*/
}