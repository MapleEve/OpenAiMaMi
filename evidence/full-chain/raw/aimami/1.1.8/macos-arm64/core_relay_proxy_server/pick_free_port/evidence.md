# evidence — pick_free_port (mac 1.1.8) — 行为后端 relay-proxy/bootstrap (用户复审补漏批2)



## Confirmed
- owner: core::relay::proxy::server::pick_free_port @ 0x1005a5b80; call-tree depth=3 节点=24(真实decompile)。
