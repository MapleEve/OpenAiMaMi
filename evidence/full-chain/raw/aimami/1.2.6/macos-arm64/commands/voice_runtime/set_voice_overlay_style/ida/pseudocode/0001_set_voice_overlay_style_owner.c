// codexmate_lib::commands::voice_runtime::set_voice_overlay_style
// owner_ea: 0x100495610, size: 0xf1
...
// notes: Tauri wrapper: runtime::set_overlay_style -> CoreEnvelope::ok

// 1.2.4→1.2.6 delta 新增命令: Tauri 命令包装器,委托 core::voice::runtime::set_overlay_style。A-level owner for commands::voice_runtime::set_voice_overlay_style
_QWORD *__fastcall codexmate_lib::commands::voice_runtime::set_voice_overlay_style::ha8d45c08e1568d39(
        _QWORD *__dst,
        __int64 a2)
{
  __int64 v2; // rax
  ...
  codexmate_lib::core::voice::runtime::set_overlay_style::h5b207415027c3f51(v6);
  v7 = v6[1];
  v8 = v6[2];
  v9 = v6[3];
  if ( v6[0] == 2 )
