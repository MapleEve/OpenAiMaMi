// Pseudocode for load_tool_analytics (EA: 0x140d939b0, size: 0x141b)
// Module: commands/analytics
// Source: IDA Hex-Rays decompiler
// IDA Comment: Tauri命令handler:加载工具调用分析(range)。归属:锚src\commands\analytics.rs。
// Tauri命令handler:加载工具调用分析(range)。归属:锚src\commands\analytics.rs。
char __fastcall load_tool_analytics(__int64 a1, __int64 a2)
{
  __int64 v3; // rbx
  __int64 v4; // rax
  __int64 *v5; // rdi
...
LABEL_38:
          ...
          if ( *((_DWORD *)v43 + 4) == 2 )
          {
            ...
            v45 = v43[1] + v44;
            v154 = 0;
            v46 = sub_14085E790(v45, v43, &v72, &off_1417EBF48);
          }
          else
          {
            v47 = 704;
            ...
            v48 = v43[9] + v47;
            v154 = 0;
            v46 = sub_14085E790(v48, v43 + 8, &v72, &off_1417EBF30);
          }
          v3 = v151;
