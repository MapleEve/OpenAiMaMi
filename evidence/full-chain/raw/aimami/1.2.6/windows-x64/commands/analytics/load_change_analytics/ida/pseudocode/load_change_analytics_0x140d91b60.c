// Pseudocode for load_change_analytics (EA: 0x140d91b60, size: 0x141b)
// Module: commands/analytics
// Source: IDA Hex-Rays decompiler
// IDA Comment: Tauri命令handler:加载变更分析(range)。归属:锚src\commands\analytics.rs。
// Tauri命令handler:加载变更分析(range)。归属:锚src\commands\analytics.rs。
char __fastcall load_change_analytics(__int64 a1, __int64 a2)
{
  __int64 v3; // rbx
  __int64 v4; // rax
  __int64 *v5; // rdi
...
LABEL_38:
          ...
          if ( *((_DWORD *)v43 + 4) == 2 )
          {
            ...
            v45 = v43[1] + v44;
            v154 = 0;
            v46 = sub_14085F060(v45, v43, &v72, &off_1417EBF48);
          }
          else
          {
            v47 = 704;
            ...
            v48 = v43[9] + v47;
            v154 = 0;
            v46 = sub_14085F060(v48, v43 + 8, &v72, &off_1417EBF30);
          }
          v3 = v151;
          *(_QWORD *)(v151 + 7952) = v46;
LABEL_48:
          v139 = (__int64 *)(v3 + 7952);
          sub_140504390(&v127, v3 + 7952, a2);
          v16 = v127;
          if ( v127 == (__int64 *)-3LL )
          {
            *(_BYTE *)Address = 3;
