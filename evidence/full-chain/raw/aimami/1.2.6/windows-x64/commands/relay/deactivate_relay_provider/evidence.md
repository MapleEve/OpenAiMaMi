# Evidence: deactivate_relay_provider

## 命令身份
- 命令名: `deactivate_relay_provider`
- Owner EA: `0x14016f920`
- Owner 函数名: `deactivate_relay_provider`
- 模块: `commands/relay`
...
## 反编译
- 文件: `ida/pseudocode/deactivate_relay_provider_0x14016f920.c`
- 状态: decompiled
...
## 字符串引用
- `0x0x14177a9cc`: deactivate_relay_provider
