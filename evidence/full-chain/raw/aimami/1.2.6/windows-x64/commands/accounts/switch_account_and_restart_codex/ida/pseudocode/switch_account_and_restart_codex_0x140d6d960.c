// Pseudocode for switch_account_and_restart_codex (EA: 0x140d6d960, size: 0xe22)
// Module: commands/accounts
// Source: IDA Hex-Rays decompiler
// Tauri命令handler:切换当前账号到accountKey并重启Codex使生效。⚠副作用:重启Codex进程。归属:锚src\commands\accounts.rs。
char __fastcall switch_account_and_restart_codex(__int64 a1, __int64 a2)
{
  __int64 v3; // r13
  __int64 v4; // rax
  __int64 v5; // rbx
...
LABEL_24:
          ...
          if ( *((_DWORD *)v34 + 4) == 2 )
          {
            ...
            v36 = v34[1] + v35;
            v109 = 0;
            v37 = sub_14085CA40(v36, v34, v64, &off_1417EBF48);
          }
          else
          {
            v38 = 704;
            ...
            v39 = v34[9] + v38;
            v109 = 0;
            v37 = sub_14085CA40(v39, v34 + 8, v64, &off_1417EBF30);
          }
          v3 = v108;
