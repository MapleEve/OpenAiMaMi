# Evidence: load_pending_auto_switch

## 命令身份
- 命令名: `load_pending_auto_switch`
- Owner EA: `0x14016a900`
- Owner 函数名: `load_pending_auto_switch`
...
## 反编译
- 文件: `ida/pseudocode/load_pending_auto_switch_0x14016a900.c`
- 状态: decompiled
...
## 字符串引用
- `0x0x14177a8ae`: load_pending_auto_switch
- `0x0x14177a18a`: repo
