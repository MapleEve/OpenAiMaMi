// Pseudocode for confirm_pending_auto_switch_and_restart_codex (EA: 0x140d7de70, size: 0x9c3)
// Module: commands/accounts
// Source: IDA Hex-Rays decompiler
// IDA Comment: Tauri命令handler:确认挂起的auto-switch切换并重启Codex。⚠副作用:重启Codex进程。归属:锚src\commands\system.rs。
// Tauri命令handler:确认挂起的auto-switch切换并重启Codex。⚠副作用:重启Codex进程。归属:锚src\commands\system.rs。
char __fastcall confirm_pending_auto_switch_and_restart_codex(__int64 a1, __int64 a2)
{
  __int64 v3; // r13
  __int64 v4; // rax
  __int64 v5; // rsi
...
LABEL_9:
        ...
        case 1:
LABEL_55:
          JUMPOUT(0x140D7E7F1LL);
        case 2:
LABEL_52:
          v70 = v17;
          sub_14176EC20(&off_141888928);
        case 3:
          break;
      }
LABEL_10:
