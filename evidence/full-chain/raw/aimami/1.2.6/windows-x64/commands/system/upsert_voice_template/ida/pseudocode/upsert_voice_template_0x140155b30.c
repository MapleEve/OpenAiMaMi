// Pseudocode for upsert_voice_template (EA: 0x140155b30, size: 0x806)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
__int64 __fastcall sub_140155B30(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // r14
  __int64 v4; // rcx
  ...
  {
    v43 = 1;
    sub_14172C620((__int64)&v29, (__int64)&v17, (__int64)&v19);
    if ( v29.m256i_i8[0] != -1 )
    {
      v16 = v29;
      sub_14172B820(&v17, a1 + 520, 360);
      v13 = *(_OWORD *)(a1 + 880);
      v14 = *(_QWORD *)(a1 + 896);
      v15 = 1;
      v43 = 0;
      sub_140AFFC30((__int64)&v17, v10, (__int64)&v15, &v13, v11, v12);
      goto LABEL_16;
    }
    v3 = v29.m256i_i64[1];
  }
  ...
  if ( v28.m256i_i8[0] == -1 )
  {
    ...
    if ( v27.m256i_i8[0] == -1 )
    {
      ...
      if ( v26.m256i_i8[0] == -1 )
      {
        ...
        v21 = v7;
        v22 = &v35;
        sub_140955980(&v31, &v17);
        LOBYTE(v41) = v31.m256i_i8[0];
        if ( v31.m256i_i8[0] == -1 )
        {
          v25 = v31.m256i_i64[3];
          v24 = *(_OWORD *)&v31.m256i_u64[1];
          sub_1409FAA40(&v13, v3, &v39, &v37, &v33, &v24);
          sub_14172B820(&v17, a1 + 520, 400);
          if ( (_QWORD)v13 == -1 )
          {
            v42 = 1;
            sub_1401A80B0(&v31, (char *)&v13 + 8);
            v16 = v31;
            v15 = -1;
          }
          else
          {
            sub_14172B820(&v15, &v13, 320);
          }
          v42 = 0;
          sub_140A94D20(&v17, &v15);
          goto LABEL_16;
        }
        v16 = v31;
        sub_14172B820(&v17, a1 + 520, 360);
