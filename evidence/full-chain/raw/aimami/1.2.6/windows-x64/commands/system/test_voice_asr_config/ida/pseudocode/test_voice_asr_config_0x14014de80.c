// Pseudocode for test_voice_asr_config (EA: 0x14014de80, size: 0x705)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
__int64 __fastcall sub_14014DE80(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rsi
  ...
  if ( v21.m256i_i8[0] == -1 )
  {
    ...
    if ( v20.m256i_i8[0] == -1 )
    {
      ...
      if ( v19.m256i_i8[0] == -1 )
      {
        ...
        v14 = v5;
        v15 = &v39;
        sub_140955980(&v35, &v10);
        LOBYTE(v45) = v35.m256i_i8[0];
        if ( v35.m256i_i8[0] == -1 )
        {
          v18 = v35.m256i_i64[3];
          v17 = *(_OWORD *)&v35.m256i_u64[1];
          sub_1409F9190((unsigned int)&v22, (unsigned int)&v43, (unsigned int)&v41, (unsigned int)&v37, (__int64)&v17);
          sub_14172B820(&v10, a1 + 520, 400);
          if ( (_QWORD)v22 == -1 )
          {
            v46 = 1;
            sub_1401A80B0(&v35, (char *)&v22 + 8);
            *(__m256i *)&v30[8] = v35;
            *(_QWORD *)v30 = -1;
          }
          else
          ...
          v46 = 0;
          sub_140A956B0(&v10, v30);
          goto LABEL_11;
        }
        *(__m256i *)&v30[8] = v35;
        sub_14172B820(&v10, a1 + 520, 360);
        v22 = *(_OWORD *)(a1 + 880);
        *(_QWORD *)&v23 = *(_QWORD *)(a1 + 896);
        *(_QWORD *)v30 = 1;
        sub_140AFFC30((__int64)&v10, v7, (__int64)v30, &v22, v8, v9);
        if ( (_QWORD)v37 )
