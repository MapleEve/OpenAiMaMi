// Pseudocode for set_usage_refresh_interval (EA: 0x14016bc40, size: 0x5db)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
// IDA Comment: Tauri 命令 set_usage_refresh_interval 处理器（commands::system，argKeys: interval）。设置用量刷新间隔。⚠副作用：写配置。
// Tauri 命令 set_usage_refresh_interval 处理器（commands::system，argKeys: interval）。设置用量刷新间隔。⚠副作用：写配置。
__int64 __fastcall set_usage_refresh_interval(__int64 a1)
{
  ...
  v27 = &v40;
  v46 = 1;
  sub_1401A9630((__int64)&v29, (__int64)&v22);
  if ( v29 == -1 )
  {
    v39 = v30;
    ...
    *(_OWORD *)v37.m256i_i8 = *(_OWORD *)(a1 + 880);
    ...
    v38 = 1;
    v46 = 0;
    sub_140AFFC30((__int64)&v22, v18, (__int64)&v38, (__int128 *)v37.m256i_i8, v19, v20);
    goto LABEL_22;
  }
  sub_14172B820(v21, &v29, 152);
  v28 = 0;
  v22 = aSetUsageRefres;
  v23 = 26;
  v24 = aRepo;
  ...
  v26 = v15;
  v27 = &v40;
  v2 = sub_140029DD0((volatile void *)(v16 + 16));
  if ( !v2 )
  {
    sub_14172C620((__int64)&v35, (__int64)&v22, (__int64)&v24);
    if ( v35.m256i_i8[0] != -1 )
    {
      v39 = v35;
      sub_14172B820(&v22, a1 + 520, 360);
...
LABEL_11:
        ...
        *(_QWORD *)&v8 = v10;
        sub_14172B820(v10, *((_QWORD *)&v7 + 1), *((_QWORD *)&v8 + 1));
      }
      else
      {
        *(_QWORD *)&v8 = 1;
  ...
  v32 = *(_QWORD *)(a1 + 896);
  v38 = 1;
  sub_140AFFC30((__int64)&v22, v18, (__int64)&v38, &v31, v19, v20);
  v46 = 0;
  sub_1400437E0(v21);
LABEL_22:
  if ( (_QWORD)v40 != -1 )
