// Pseudocode for get_hotspot_enabled (EA: 0x140173550, size: 0x378)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
// IDA Comment: Tauri 命令 get_hotspot_enabled 处理器（commands::hotspot）。读取热点开关状态。
// Tauri 命令 get_hotspot_enabled 处理器（commands::hotspot）。读取热点开关状态。
__int64 __fastcall sub_140173550(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rdx
  __int64 v4; // rcx
