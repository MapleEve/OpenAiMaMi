// Pseudocode for test_voice_llm_config (EA: 0x14014fae0, size: 0x6e9)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
__int64 __fastcall sub_14014FAE0(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rsi
  ...
  if ( (_BYTE)v28 == 0xFF )
  {
    ...
    if ( (_BYTE)v26 == 0xFF )
    {
      ...
      if ( (_BYTE)v24 == 0xFF )
      {
        ...
        *(_QWORD *)v32 = 1;
        sub_140AFFC30((__int64)&v10, v7, (__int64)v32, &v17, v8, v9);
        if ( v41 )
