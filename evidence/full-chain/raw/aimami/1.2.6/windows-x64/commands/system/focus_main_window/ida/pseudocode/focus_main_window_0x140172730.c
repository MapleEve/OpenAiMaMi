// Pseudocode for focus_main_window (EA: 0x140172730, size: 0x35c)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
// IDA Comment: Tauri 命令 focus_main_window 处理器（commands::hotspot，mac 符号）。聚焦/前置主窗口。
// Tauri 命令 focus_main_window 处理器（commands::hotspot，mac 符号）。聚焦/前置主窗口。
__int64 __fastcall sub_140172730(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  __int64 v4; // r8
