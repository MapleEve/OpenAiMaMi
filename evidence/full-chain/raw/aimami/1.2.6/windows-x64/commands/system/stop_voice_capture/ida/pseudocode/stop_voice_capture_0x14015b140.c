// Pseudocode for stop_voice_capture (EA: 0x14015b140, size: 0x42c)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
// IDA Comment: 职责：停止语音捕获的 core 层 owner 实现（core::voice::runtime::stop_capture），被命令层 stop_voice_capture 调用，处理音频流停止与资源释放。边界：core::voice::runtime 模块，归属 /codexmate_lib/core/voice/runtime/。副作用：停止音频捕获设备占用，释放相关运行时资源。mac 侧对应
// 职责：停止语音捕获的 core 层 owner 实现（core::voice::runtime::stop_capture），被命令层调用，处理音频流停止与资源释放。core::voice::runtime 模块。mac对应符号 core::voice::runtime::stop_capture，owner-map 扩展法定位。
__int64 __fastcall stop_voice_capture_owner_sys(__int64 a1)
{
  ...
  if ( v27 != -1 )
  {
    ...
    stop_voice_capture_core_sys(&v30, v26);
    v3 = v30;
    v4 = v31;
    v5 = v32;
    v6 = v33;
