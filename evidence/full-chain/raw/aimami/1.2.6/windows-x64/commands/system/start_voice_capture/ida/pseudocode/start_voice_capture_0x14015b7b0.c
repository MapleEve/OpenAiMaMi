// Pseudocode for start_voice_capture (EA: 0x14015b7b0, size: 0x42c)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
// IDA Comment: 职责：Tauri 命令 start_voice_capture 的 dispatch 入口，薄壳转发到 core::voice::runtime::start_capture，结果经 CoreEnvelope::ok 包装返回。边界：commands::voice_runtime 模块，薄壳转发模式。副作用：转发调用触发下游开始语音捕获（音频设备占用）。1.2.4→1.2.6 delta 新增命令
// 职责：Tauri 命令 start_voice_capture dispatch 入口，薄壳转发到 core::voice::runtime::start_capture，结果经 CoreEnvelope::ok 返回。commands::voice_runtime 模块。副作用：转发触发下游开始语音捕获。1.2.4->1.2.6 delta 新增，mac符号 commands::voice_runtime::start_voice_capture，命令名串唯一 xref 定位。
__int64 __fastcall start_voice_capture(__int64 a1)
{
  __int64 v2; // rsi
  __int64 v3; // rbx
  __int64 v4; // r14
  ...
  if ( v27 != -1 )
  {
    ...
    start_capture_core_and_sidecar_scheduler(&v30, v26);
    v3 = v30;
    v4 = v31;
    v5 = v32;
    v6 = v33;
