// Pseudocode for get_device_id (EA: 0x140169df0, size: 0x388)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
// IDA Comment: Tauri 命令 get_device_id 处理器（commands::system，mac 符号）。读取设备唯一标识。
// Tauri 命令 get_device_id 处理器（commands::system，mac 符号）。读取设备唯一标识。
__int64 __fastcall sub_140169DF0(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rdx
  __int64 v4; // rcx
