// Pseudocode for set_voice_mode_shortcut (EA: 0x140159880, size: 0xb1d)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
__int64 __fastcall sub_140159880(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // r8
  __int64 v4; // r9
  ...
  *((_QWORD *)&v21 + 1) = v10;
  v22 = &v34;
  v45 = 1;
  sub_1401A9630((__int64)&v11, (__int64)&v19);
  if ( v11 == -1 )
  {
    v14 = v12;
    sub_14172B820(&v19, a1 + 520, 360);
    *(_OWORD *)v40.m256i_i8 = *(_OWORD *)(a1 + 880);
    v40.m256i_i64[2] = *(_QWORD *)(a1 + 896);
    v13 = 1;
    v45 = 0;
    sub_140AFFC30((__int64)&v19, v16, (__int64)&v13, (__int128 *)v40.m256i_i8, v17, v18);
  }
  else
  {
    sub_14172B820(v24, &v11, 152);
    v23 = 0;
    v19 = (__int64)aSetVoiceModeSh;
    *(_QWORD *)&v20 = 23;
          ...
          if ( v29.m256i_i8[0] == -1 )
          {
            ...
            *((_QWORD *)&v21 + 1) = v10;
            ...
            if ( v27.m256i_i8[0] == -1 )
            {
              ...
              *((_QWORD *)&v21 + 1) = v10;
              v22 = &v34;
              sub_140954A30(&v40, &v19);
              LOBYTE(v43) = v40.m256i_i8[0];
              if ( v40.m256i_i8[0] == -1 )
              {
                v9 = &v38;
                sub_1403D6380((__int128 *)&v13, (char)v24, (char)&v41, v5);
                sub_14172B820(&v11, v15, 400);
                if ( (_DWORD)v13 == 2 )
                {
                  v44 = 1;
                  sub_1401A80B0(v24, &v14);
                  v21 = v24[1];
                  v20 = v24[0];
                  v19 = 2;
                }
                ...
                {
                  sub_14172B820(&v19, &v13, 792);
                }
                v44 = 0;
                sub_140A946C0(&v11, &v19);
                goto LABEL_39;
              }
              v14 = v40;
              sub_14172B820(&v19, a1 + 520, 360);
              ...
              v26 = *(_QWORD *)(a1 + 896);
              v13 = 1;
              sub_140AFFC30((__int64)&v19, v16, (__int64)&v13, &v25, v17, v18);
              if ( (_QWORD)v36 )
...
LABEL_39:
  if ( (_QWORD)v34 != -1 )
  {
    ...
    while ( v33 != v43 )
    {
      ++v43;
      v7 = v6 + 96;
      sub_140401FB0(v6, v2, v3, v4, v9);
      v6 = v7;
    }
    if ( (_QWORD)v34 )
      sub_140001660(*((_QWORD *)&v34 + 1), 96 * v34, 8);
  }
  return sub_140043900(v10);
}
