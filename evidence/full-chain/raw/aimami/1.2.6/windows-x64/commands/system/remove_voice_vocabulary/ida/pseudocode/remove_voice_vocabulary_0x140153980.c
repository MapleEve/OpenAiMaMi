// Pseudocode for remove_voice_vocabulary (EA: 0x140153980, size: 0x4be)
// Module: commands/system
// Source: IDA Hex-Rays decompiler
__int64 __fastcall sub_140153980(__int64 a1)
{
  __int64 v2; // r14
  __int64 v3; // rdx
  __int64 v4; // rcx
