...
class o extends t {
  ...
  async download(e, n) {
    ...
    const s = new i;
    e && (s.onmessage = e);
    const l = await a("plugin:updater|download", {
      onEvent: s,
      rid: this.rid,
      ...n
    });
    this.downloadedBytes = new t(l)
  }
  async install() {
    if (!this.downloadedBytes) throw new Error("Update.install called before Update.download");
    await a("plugin:updater|install", {
      updateRid: this.rid,
  ...
  async downloadAndInstall(e, n) {
    r(n);
    const s = new i;
    e && (s.onmessage = e), await a("plugin:updater|download_and_install", {
      onEvent: s,
      rid: this.rid,
      ...n
    })
...
async function w(d) {
  r(d);
  const e = await a("plugin:updater|check", {
    ...d
  });
...
function r(d) {
  d != null && d.headers && (d.headers = Array.from(new Headers(d.headers).entries()))
}
export {
  o as Update, w as check
};