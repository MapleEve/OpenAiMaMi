# evidence.md — set_codex_no_account_slots (1.2.4 win delta)
...
**Gate pass**: True
**Destructive**: False
**Pseudocode**: ida/pseudocode/set_codex_no_account_slots_0x140e2de30.c

## Confirmed
- Owner function located at 0x140e2de30 via command name string xref (win-native, red line 31 independent verification).
- Full decompile obtained (red line 20 truncation check: PASS, no truncation markers).
- Callee set deduped: 29 unique callees.
- Call-tree depth=1, edges=29, gate=PASS (edges>=5).
- Entry signature: set_codex_no_account_slots(a1, a2) -> char
