// module: codexmate_lib/commands/relay/quit_keeping_router
// addr: 0x140173f00
...
__int64 __fastcall quit_keeping_router(__int64 a1)
{
  ...
  const char *v23; // [rsp+478h] [rbp+3F8h] BYREF
  ...
  v26 = &v39;
  v45 = 1;
  sub_1401B1BF0(&v28, &v21);
  if ( v28 == -1 )
  {
    v38 = v30;
    v37 = v29;
    sub_1416F15C0(&v21, a1 + 520, 360);
    v34 = *(_OWORD *)(a1 + 880);
    *(_QWORD *)&v35 = *(_QWORD *)(a1 + 896);
    v36 = 1;
    v45 = 0;
    sub_1407A09A0((unsigned int)&v21, v17, (unsigned int)&v36, (unsigned int)&v34, v18, v19);
  }
  else
  {
    sub_1416F15C0(v20, &v28, 152);
    v27 = 0;
    v21 = aQuitKeepingRou;
    v22 = 19;
    v23 = aManager_0;
    ...
    if ( v2 )
      goto LABEL_3;
    sub_1416F2670(&v34, &v21, &v23);
    if ( (_BYTE)v34 == 0xFF )
    {
      v2 = *((_QWORD *)&v34 + 1);
LABEL_3:
      v44 = 1;
      sub_140B90440(&v36, v20, v2);
      sub_1416F15C0(&v21, a1 + 520, 400);
      v6 = v36;
      if ( v36 == -1 )
      {
        LOBYTE(v28) = -1;
...
LABEL_15:
    ...
    v36 = 1;
    v44 = 0;
    sub_1407A09A0((unsigned int)&v21, v17, (unsigned int)&v36, (unsigned int)&v31, v18, v19);
    v45 = 0;
    sub_140041330(v20);
  }
LABEL_17:
