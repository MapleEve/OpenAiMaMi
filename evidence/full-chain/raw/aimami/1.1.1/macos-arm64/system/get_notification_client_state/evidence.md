...
**逆向分析 health**: status=ok, uptime=53523s, hexrays_ready=true, module=AiMaMi, auto_analysis_ready=true
...
- dim6 (test/acceptance): Unknown (C5 implementation side — reversal ceiling)
