# load_tool_analytics — Call Tree (Windows x64)
# session: <审计会话>
# owner VA: 0x1400264A0 | size: 0x511

## Depth-annotated tree

```
L0: sub_1400264A0 (load_tool_analytics handler)  @ 0x1400264A0
  ...
  L1: sub_1401C9280 (tool range filter)           @ 0x1401C9280
    L2: sub_14124A510 (spinlock wait)             @ 0x14124A510
    ...
    L2: WakeByAddressSingle                       @ 0x14124A5D0  [WinAPI]
    L2: sub_140203160 (tool range matcher)        @ 0x140203160  [DISTINCT: only for tool analytics]
    L2: sub_1402168D0 (tool/session response ctor) @ 0x1402168D0 [shared with session, not change]
  ...
  L1: sub_140837390 (tool analytics response builder) @ 0x140837390
...
- max_depth: 3
- edges: 23
- NOTE: tool_range_filter uses sub_140203160 (distinct range matcher) but shares
  sub_1402168D0 response constructor with session_range_filter
