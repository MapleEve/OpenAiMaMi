// 1.2.3 census-gap-fill (real_body,on_disk=false) | _<codexmate_lib::core::models::_::<impl serde_core::de::Deserialize for codexmate_lib::core::models::McpTransport>::deserialize::__FieldVisitor as serde_core::de::Visitor>::visit_bytes::h92baf78a1b9c44ba @ 0x100374dd0 | full-body via IDA decompiler
