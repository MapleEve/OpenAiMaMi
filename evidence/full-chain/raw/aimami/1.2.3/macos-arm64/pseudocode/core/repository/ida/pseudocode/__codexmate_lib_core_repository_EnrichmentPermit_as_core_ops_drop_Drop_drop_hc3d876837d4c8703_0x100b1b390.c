// 1.2.3 census-gap-fill (real_body,on_disk=false) | _<codexmate_lib::core::repository::EnrichmentPermit as core::ops::drop::Drop>::drop::hc3d876837d4c8703 @ 0x100b1b390 | full-body via IDA decompiler
