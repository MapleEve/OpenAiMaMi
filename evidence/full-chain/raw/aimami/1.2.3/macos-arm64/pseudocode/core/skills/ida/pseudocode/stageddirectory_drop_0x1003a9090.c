// 1.2.3 baseline same-set | __ZN86_$LT$codexmate_lib..core..skills..StagedDirectory$u20$as$u20$core..ops..drop..Drop$GT$4drop17h2f1fafacce2d5901E @ 0x1003a9090 | full-body via IDA decompiler
