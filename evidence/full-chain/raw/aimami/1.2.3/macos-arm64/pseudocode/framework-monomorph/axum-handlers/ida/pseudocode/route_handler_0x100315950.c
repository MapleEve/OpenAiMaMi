/* addr=0x100315950 cleanname=route_handler group=axum-handlers
 * n_lines=586 brace_balanced=True truncation_markers=[]
 */
_QWORD *__fastcall _$LT$F$u20$as$u20$axum..handler..Handler$LT$$LP$M$C$T1$C$T2$C$T3$C$T4$C$T5$RP$$C$S$GT$$GT$::call::_$u7b$$u7b$closure$u7d$$u7d$::hb5bd9fe8c1c550b6(
        _QWORD *a1,
        __int64 a2,
        __int64 a3,
        __m128 a4)
      ...
      switch ( v11 )
      {
        case 0LL:
          *(_QWORD *)&v102 = a3;
          ...
          goto LABEL_63;
        case 1LL:
          core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_10195D5F0);
        case 2LL:
          core::panicking::panic_const::panic_const_async_fn_resumed_panic::h51796ee0ce4d776a(&off_10195D5F0);
        case 3LL:
          goto LABEL_81;
        case 4LL:
