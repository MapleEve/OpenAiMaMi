/* addr=0x1001985f0 cleanname=ipc_dispatch group=tauri-ipc-dispatch
 * n_lines=703 brace_balanced=True truncation_markers=[]
 */
char __fastcall tauri::ipc::InvokeResolver$LT$R$GT$::respond_async_serialized_inner::_$u7b$$u7b$closure$u7d$$u7d$::hacbc06c14365e57d(
...
LABEL_4:
          v6 = __src + 3968;
          *(_QWORD *)&__dst[3] = 0;
          *(_QWORD *)&__dst[0] = "load_session_analyticsimport_skillpreview_account_importset_auto_switchrestore_skill_backupinject_voice_textcapture_voice_trigger_keystyleget_relay_provider_quotadetect_api_proxy_configquit_after_closing_routerload_change_analyticsset_codex_router_no_account_moderun_daemon_onceswitch_accounttest_relay_draft_streamfetch_relay_models_draftswitch_account_and_restart_codexconfirm_pending_auto_switch_and_restart_codexremove_skillload_skill_backups127.0.0.1:1455/auth/callback";
          *((_QWORD *)&__dst[0] + 1) = 22;
...
LABEL_26:
          ...
          *((_QWORD *)__src + 808) = tauri::async_runtime::spawn_blocking::hd72db8ecbaaff098(__dst);
LABEL_28:
...
LABEL_69:
          ...
          else
          {
            ...
            v79 = v45;
            v80 = v23;
            _$LT$T$u20$as$u20$tauri..ipc..IpcResponse$GT$::body::h55608c0ad81620d1(__dst, &v76, *(double *)a3.i64);
...
LABEL_89:
        ...
        case 1u:
LABEL_103:
          core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_101952C78);
        case 2u:
LABEL_102:
          core::panicking::panic_const::panic_const_async_fn_resumed_panic::h51796ee0ce4d776a(&off_101952C78);
        case 3u:
LABEL_25:
          v126 = __src + 6472;
          v26 = (char *)(__src + 5696);
