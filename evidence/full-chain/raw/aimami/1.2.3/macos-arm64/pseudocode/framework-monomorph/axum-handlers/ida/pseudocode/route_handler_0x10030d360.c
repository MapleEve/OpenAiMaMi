/* addr=0x10030d360 cleanname=route_handler group=axum-handlers
 * n_lines=301 brace_balanced=True truncation_markers=[]
 */
_QWORD *__fastcall _$LT$F$u20$as$u20$axum..handler..Handler$LT$$LP$M$C$T1$C$T2$C$T3$RP$$C$S$GT$$GT$::call::_$u7b$$u7b$closure$u7d$$u7d$::hfff4994d5631c1bd(
        _QWORD *a1,
        __int64 a2,
        __int64 a3,
        __m128 a4)
    ...
    case 6:
      ...
      switch ( *(_BYTE *)(a2 + 1248) )
      {
        case 0:
          ...
          goto LABEL_32;
        case 1:
          core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_10195D858);
        case 2:
          core::panicking::panic_const::panic_const_async_fn_resumed_panic::h51796ee0ce4d776a(&off_10195D858);
        case 3:
          goto LABEL_34;
      }
  }
