/* addr=0x10013e6c0 cleanname=ipc_dispatch group=tauri-ipc-dispatch
 * n_lines=897 brace_balanced=True truncation_markers=[]
 */
char __fastcall tauri::ipc::InvokeResolver$LT$R$GT$::respond_async_serialized_inner::_$u7b$$u7b$closure$u7d$$u7d$::h25a43c9b5753487c(
        ...
        char *a2)
{
  ...
  __int64 v112; // rsi
  __int64 v113; // rax
  _BYTE v114[384]; // [rsp+8h] [rbp-D18h] BYREF
  _BYTE v115[384]; // [rsp+188h] [rbp-B98h] BYREF
  _QWORD v116[3]; // [rsp+308h] [rbp-A18h] BYREF
  char v117; // [rsp+320h] [rbp-A00h]
  _BYTE v118[7]; // [rsp+321h] [rbp-9FFh]
  __int64 v119; // [rsp+328h] [rbp-9F8h]
  _BYTE v120[304]; // [rsp+330h] [rbp-9F0h] BYREF
  _QWORD v121[48]; // [rsp+460h] [rbp-8C0h] BYREF
  _QWORD v122[38]; // [rsp+5E0h] [rbp-740h] BYREF
  __int64 v123; // [rsp+710h] [rbp-610h] BYREF
  __int64 v124; // [rsp+718h] [rbp-608h]
  void *v125; // [rsp+720h] [rbp-600h]
  __int64 v126; // [rsp+728h] [rbp-5F8h]
  _QWORD *v127; // [rsp+730h] [rbp-5F0h]
  _BYTE v128[384]; // [rsp+738h] [rbp-5E8h] BYREF
  __int64 __dst[38]; // [rsp+8B8h] [rbp-468h] BYREF
  _QWORD v130[6]; // [rsp+9E8h] [rbp-338h] BYREF
  __int64 v131; // [rsp+A18h] [rbp-308h] BYREF
  char v132; // [rsp+A20h] [rbp-300h]
  _BYTE v133[7]; // [rsp+A21h] [rbp-2FFh]
  unsigned __int64 v134; // [rsp+A28h] [rbp-2F8h]
  void *v135; // [rsp+A30h] [rbp-2F0h]
  __int64 v136; // [rsp+A38h] [rbp-2E8h]
  _BYTE v137[424]; // [rsp+A40h] [rbp-2E0h] BYREF
  void *v138; // [rsp+BE8h] [rbp-138h]
  size_t v139; // [rsp+BF0h] [rbp-130h]
  void *v140; // [rsp+BF8h] [rbp-128h]
  __int64 v141; // [rsp+C00h] [rbp-120h]
  __int64 v142; // [rsp+C08h] [rbp-118h]
  void *v143; // [rsp+C10h] [rbp-110h]
  __int64 v144; // [rsp+C18h] [rbp-108h]
  unsigned __int64 v145; // [rsp+C20h] [rbp-100h]
  __int64 v146; // [rsp+C28h] [rbp-F8h]
  __int64 v147; // [rsp+C30h] [rbp-F0h] BYREF
  __int64 v148; // [rsp+C38h] [rbp-E8h]
  size_t v149; // [rsp+C40h] [rbp-E0h]
  __int64 v150; // [rsp+C48h] [rbp-D8h]
  size_t v151; // [rsp+C50h] [rbp-D0h]
  void *v152; // [rsp+C58h] [rbp-C8h]
  __int64 v153; // [rsp+C60h] [rbp-C0h]
  __int64 v154; // [rsp+C68h] [rbp-B8h]
  __int64 v155; // [rsp+C70h] [rbp-B0h]
  __int64 v156; // [rsp+C78h] [rbp-A8h]
  _DWORD v157[2]; // [rsp+C80h] [rbp-A0h]
  _BYTE v158[7]; // [rsp+C88h] [rbp-98h]
  _BYTE *v159; // [rsp+C90h] [rbp-90h]
  void *v160; // [rsp+C98h] [rbp-88h]
  _DWORD v161[2]; // [rsp+CA0h] [rbp-80h]
  _BYTE v162[7]; // [rsp+CA8h] [rbp-78h]
  __int64 v163; // [rsp+CB0h] [rbp-70h] BYREF
  __int64 v164; // [rsp+CB8h] [rbp-68h]
  __int64 v165; // [rsp+CC0h] [rbp-60h]
  char *v166; // [rsp+CC8h] [rbp-58h]
  unsigned __int8 *v167; // [rsp+CD0h] [rbp-50h]
  _QWORD *v168; // [rsp+CD8h] [rbp-48h]
  __int64 v169; // [rsp+CE0h] [rbp-40h]
  unsigned __int64 v170; // [rsp+CE8h] [rbp-38h]
  _BYTE v171[41]; // [rsp+CF7h] [rbp-29h] BYREF
...
LABEL_4:
          v5 = __src + 3872;
          *(_QWORD *)&v137[48] = 0;
          *(_QWORD *)v137 = "import_skillpreview_account_importset_auto_switchrestore_skill_backupinject_voice_textcapture_voice_trigger_keystyleget_relay_provider_quotadetect_api_proxy_configquit_after_closing_routerload_change_analyticsset_codex_router_no_account_moderun_daemon_onceswitch_accounttest_relay_draft_streamfetch_relay_models_draftswitch_account_and_restart_codexconfirm_pending_auto_switch_and_restart_codexremove_skillload_skill_backups127.0.0.1:1455/auth/callback";
          *(_QWORD *)&v137[8] = 12;
          *(_QWORD *)&v137[16] = "repomodepathtextdataunittypefullargsopenwithkindsavetrueuuidemitshowhide";
          *(_QWORD *)&v137[24] = 4;
          v166 = v4;
          *(_QWORD *)&v137[32] = v4;
          *(_QWORD *)&v137[40] = __src + 3872;
...
LABEL_7:
            ...
            *(_QWORD *)v137 = "import_skillpreview_account_importset_auto_switchrestore_skill_backupinject_voice_textcapture_voice_trigger_keystyleget_relay_provider_quotadetect_api_proxy_configquit_after_closing_routerload_change_analyticsset_codex_router_no_account_moderun_daemon_onceswitch_accounttest_relay_draft_streamfetch_relay_models_draftswitch_account_and_restart_codexconfirm_pending_auto_switch_and_restart_codexremove_skillload_skill_backups127.0.0.1:1455/auth/callback";
            *(_QWORD *)&v137[8] = 12;
            *(_QWORD *)&v137[16] = "pathtextdataunittypefullargsopenwithkindsavetrueuuidemitshowhide";
            *(_QWORD *)&v137[24] = 4;
            *(_QWORD *)&v137[32] = v166;
            *(_QWORD *)&v137[40] = __src + 3872;
            _$LT$D$u20$as$u20$tauri..ipc..command..CommandArg$LT$R$GT$$GT$::from_command::h8ef43ece7a700d6d(&v123, v137);
            v7 = v123;
            if ( (_BYTE)v123 == 6 )
            {
              v8 = v124;
...
LABEL_21:
              ...
              __src[6289] = 0;
              *(_QWORD *)&v137[16] = *((_QWORD *)__src + 715);
              v21 = *((_QWORD *)__src + 713);
              *(_QWORD *)&v137[8] = *((_QWORD *)__src + 714);
              *(_QWORD *)v137 = v21;
              v22 = *((_QWORD *)__src + 734);
              *(_QWORD *)&v137[32] = *((_QWORD *)__src + 735);
              *(_QWORD *)&v137[40] = *((_QWORD *)__src + 736);
              *(_QWORD *)&v137[24] = v22;
              *(_QWORD *)&v137[48] = v154;
              *(_QWORD *)&v137[56] = v155;
              *(_QWORD *)&v137[64] = v142;
              *((_QWORD *)__src + 785) = tauri::async_runtime::spawn_blocking::h8084e72300b85581(v137);
LABEL_24:
              _$LT$tokio..runtime..task..join..JoinHandle$LT$T$GT$$u20$as$u20$core..future..future..Future$GT$::poll::h659480da5be33c74(v137);
              v23 = *(_QWORD *)v137;
              if ( *(_QWORD *)v137 == 4 )
              {
                __src[6288] = 3;
              ...
              else
              {
                if ( *(_DWORD *)v137 == 3 )
                {
                  v169 = *(_QWORD *)&v137[8];
                  LOBYTE(v168) = v137[16];
                  LODWORD(v163) = *(_DWORD *)&v137[17];
                  *(_DWORD *)((char *)&v163 + 3) = *(_DWORD *)&v137[20];
                  v24 = *(_QWORD *)&v137[24];
                  v25 = v170 + 12;
                }
                else
                {
                  ...
                  v169 = *(_QWORD *)&v137[16];
                  LOBYTE(v168) = v137[24];
                  LODWORD(v163) = *(_DWORD *)&v137[25];
                  *(_DWORD *)((char *)&v163 + 3) = *(_DWORD *)&v137[28];
                  v24 = *(_QWORD *)&v137[32];
                  memcpy(__dst, &v137[40], sizeof(__dst));
                }
                v161[0] = v163;
                *(_DWORD *)((char *)v161 + 3) = *(_DWORD *)((char *)&v163 + 3);
                ...
                if ( (_DWORD)v23 == 2 )
                {
                  ...
                  *(_QWORD *)&v137[8] = v169;
                  v137[16] = (_BYTE)v168;
                  *(_DWORD *)&v137[17] = v161[0];
                  *(_DWORD *)&v137[20] = *(_DWORD *)((char *)v161 + 3);
                  *(_QWORD *)&v137[24] = v24;
                  *(_QWORD *)&v137[32] = v122[0];
                  *(_QWORD *)&v137[40] = v122[1];
                  *(_QWORD *)&v137[48] = v122[2];
                  *(_QWORD *)&v137[56] = v122[3];
                  *(_QWORD *)&v137[64] = v122[4];
                  *(_QWORD *)&v137[72] = v122[5];
                  *(_QWORD *)&v137[80] = v122[6];
                  *(_QWORD *)&v137[88] = v122[7];
                  v163 = 0;
                  v164 = 1;
                  v165 = 0;
                  __dst[2] = 1610612768;
                  ...
                  core::ptr::drop_in_place$LT$codexmate_lib..core..models..CoreError$GT$::h389b3279db467fcb(v137);
                  goto LABEL_38;
                }
                if ( (_DWORD)v23 == 3 )
                {
                  ...
                  *(_QWORD *)&v137[40] = v122[1];
                  ...
                  v30 = *(unsigned __int16 *)((char *)&v165 + 5);
                  v31 = *(unsigned int *)((char *)&v165 + 1);
                  core::ptr::drop_in_place$LT$tauri..error..Error$GT$::hbb2283fa0888d859((__int64 *)v137);
LABEL_38:
                ...
                *(_DWORD *)&v118[3] = *(_DWORD *)((char *)v161 + 3);
                codexmate_lib::core::models::CoreEnvelope$LT$T$GT$::ok::hd5c18ded5ca6dce7(v137, v116);
                v64 = *(_QWORD *)v137;
                v34 = *(_QWORD *)&v137[8];
                v160 = *(void **)&v137[16];
                LOBYTE(v169) = v137[24];
                v65 = v137[31];
                v66 = *(unsigned __int16 *)&v137[29];
                v156 = *(unsigned int *)&v137[25];
                v168 = *(_QWORD **)&v137[32];
                memcpy(v121, &v137[40], sizeof(v121));
...
LABEL_185:
          ...
          __dst[1] = 1;
          __dst[2] = 0;
          *(_QWORD *)&v137[16] = 1610612768;
          *(_QWORD *)v137 = __dst;
          *(_QWORD *)&v137[8] = &off_101952F18;
...
LABEL_165:
          ...
          else
          {
            ...
            v126 = v98 | v36;
            v127 = v168;
            _$LT$T$u20$as$u20$tauri..ipc..IpcResponse$GT$::body::h6fc5f39ce9b07f62(v137, &v123, v97);
            v121[0] = *(_QWORD *)&v137[8];
            v121[1] = *(_QWORD *)&v137[16];
            v121[2] = *(_QWORD *)&v137[24];
            v121[3] = *(_QWORD *)&v137[32];
            if ( *(_QWORD *)v137 == v170 + 37 )
            {
              v148 = v121[0];
              v149 = v121[1];
              v150 = v121[2];
...
LABEL_193:
        ...
        case 1u:
LABEL_208:
          core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_101952918);
        case 2u:
LABEL_207:
          core::panicking::panic_const::panic_const_async_fn_resumed_panic::h51796ee0ce4d776a(&off_101952918);
        case 3u:
          goto LABEL_24;
      }
  }
