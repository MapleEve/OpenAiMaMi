/* addr=0x100312da0 cleanname=route_handler group=axum-handlers
 * decompiled via py_exec_file server-side ida_hexrays.decompile
 * n_lines=471 brace_balanced=True truncation_markers=[]
 */
_QWORD *__fastcall _$LT$F$u20$as$u20$axum..handler..Handler$LT$$LP$M$C$T1$C$T2$C$T3$C$T4$RP$$C$S$GT$$GT$::call::_$u7b$$u7b$closure$u7d$$u7d$::hd4eba2e4bd8f1d6e(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
      ...
      *(_QWORD *)&v83 = a2 + 616;
      switch ( v11 )
      {
        case 0LL:
          ...
          goto LABEL_54;
        case 1LL:
          core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_10195D728);
        case 2LL:
          core::panicking::panic_const::panic_const_async_fn_resumed_panic::h51796ee0ce4d776a(&off_10195D728);
        case 3LL:
          goto LABEL_59;
      }
  }
