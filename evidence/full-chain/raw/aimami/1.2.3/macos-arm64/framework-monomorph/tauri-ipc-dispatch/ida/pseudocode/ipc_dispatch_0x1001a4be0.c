/* addr=0x1001a4be0 cleanname=ipc_dispatch group=tauri-ipc-dispatch
 * decompiled via IDA Python server-side IDA decompiler.decompile
 * n_lines=703 brace_balanced=True truncation_markers=[]
 */
char __fastcall tauri::ipc::InvokeResolver$LT$R$GT$::respond_async_serialized_inner::_$u7b$$u7b$closure$u7d$$u7d$::hb86f484e1aafee58(
...
LABEL_4:
          v6 = __src + 3968;
          *(_QWORD *)&__dst[3] = 0;
          *(_QWORD *)&__dst[0] = "load_tool_analyticslogoutrun_codex_router_diagnosticsrefresh_usage_snapshotload_quota_historytest_api_proxy_configurlexport_session_markdownfix_codex_router_issueitemIdset_codex_router_enabledremove_accountsload_session_analyticsimport_skillpreview_account_importset_auto_switchrestore_skill_backupinject_voice_textcapture_voice_trigger_keystyleget_relay_provider_quotadetect_api_proxy_configquit_after_closing_routerload_change_analyticsset_codex_router_no_account_moderun_daemon_onceswitch_accounttest_relay_draft_streamfetch_relay_models_draftswitch_account_and_restart_codexconfirm_pending_auto_switch_and_restart_codexremove_skillload_skill_backups127.0.0.1:1455/auth/callback";
          *((_QWORD *)&__dst[0] + 1) = 19;
...
LABEL_26:
          ...
          *((_QWORD *)__src + 808) = tauri::async_runtime::spawn_blocking::h3ef74f14f8cb2b17(__dst);
LABEL_28:
          _$LT$tokio..runtime..task..join..JoinHandle$LT$T$GT$$u20$as$u20$core..future..future..Future$GT$::poll::h37f649eff80aeb58(
            &v109,
            __src + 6464,
            v123.i64[0]);
          v28 = (__int64)v109;
...
LABEL_43:
          ...
          v64 = v20;
          v65 = v28;
          codexmate_lib::core::models::CoreEnvelope$LT$T$GT$::ok::h5c7cbf2dd1b0ed02((__int64)__dst, &v62);
          v37 = *((_BYTE **)&__dst[0] + 1);
          v36 = *(_QWORD *)&__dst[0];
...
LABEL_69:
          ...
          else
          {
            ...
            v79 = v45;
            v80 = v23;
            _$LT$T$u20$as$u20$tauri..ipc..IpcResponse$GT$::body::hdeb68d3077c0d2b3(__dst, &v76, *(double *)a3.i64);
...
LABEL_89:
        ...
        case 1u:
LABEL_103:
          core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_101952C18);
        case 2u:
LABEL_102:
          core::panicking::panic_const::panic_const_async_fn_resumed_panic::h51796ee0ce4d776a(&off_101952C18);
        case 3u:
LABEL_25:
          v126 = __src + 6472;
          v26 = (char *)(__src + 5696);
          switch ( __src[6472] )
          {
            ...
            case 1u:
              epi64 = __src + 5696;
              core::panicking::panic_const::panic_const_async_fn_resumed::h8f02a5f78cdcc4bb(&off_101952C90);
            case 2u:
              JUMPOUT(0x1001A5C5BLL);
            case 3u:
              goto LABEL_28;
          }
      }
