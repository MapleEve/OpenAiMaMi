// 1.2.3 baseline same-set | __ZN13codexmate_lib4core17session_analytics24compute_change_analytics17hb043741ba7c9bfd5E @ 0x100a87f80 | full-body via py_exec_file(ida_hexrays.decompile direct write)
