// 1.2.3 census-gap-fill (real_body,on_disk=false) | _<codexmate_lib::core::models::_::<impl serde_core::de::Deserialize for codexmate_lib::core::models::AutoSwitchStatusPayload>::deserialize::__FieldVisitor as serde_core::de::Visitor>::visit_str::ha5060abd4abf4ba5 @ 0x100379490 | full-body via py_exec_file(ida_hexrays.decompile direct write)
