// 1.2.3 census-gap-fill (real_body,on_disk=false) | _<codexmate_lib::core::models::_::<impl serde_core::de::Deserialize for codexmate_lib::core::models::AccountRefreshScope>::deserialize::__FieldVisitor as serde_core::de::Visitor>::visit_bytes::h260e4c2d1e7107b1 @ 0x100377870 | full-body via py_exec_file(ida_hexrays.decompile direct write)
