// 1.2.3 census-gap-fill (real_body,on_disk=false) | _<codexmate_lib::core::models::_::<impl serde_core::de::Deserialize for codexmate_lib::core::models::AutoSwitchRuntimeState>::deserialize::__FieldVisitor as serde_core::de::Visitor>::visit_bytes::h00c9bb9801b996b1 @ 0x100379200 | full-body via py_exec_file(ida_hexrays.decompile direct write)
