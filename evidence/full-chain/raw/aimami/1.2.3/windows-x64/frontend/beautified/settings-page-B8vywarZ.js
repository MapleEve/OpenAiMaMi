const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["assets/app-TuXtMya9.js", "assets/index-B40jKs17.js", "assets/index-CR8sKgfr.css"]))) => i.map(i => d[i]);
import {
  c as xe,
  h as be,
  p as fe,
...
`) : s(i ? "settings.autoSwitchEnabledDesc" : "settings.thresholdSavedDesc"),
  ...
  h.useEffect(() => {
    ye(() => import("./app-TuXtMya9.js"), __vite__mapDeps([0, 1, 2])).then(t => t.getVersion()).then(H).catch(() => H("unknown"))
  }, []);
