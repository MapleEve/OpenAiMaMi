...
- `func_query name_regex=rollback_custom_instruction` (Hex-Rays symbol table) -> 0 hits.
- `find_regex pattern=rollback_custom_instruction` (string pool) -> 0 hits.
