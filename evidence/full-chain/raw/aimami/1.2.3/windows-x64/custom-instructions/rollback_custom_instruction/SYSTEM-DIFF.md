# System Diff — rollback_custom_instruction (windows AiMaMi 1.0.9 -> 1.2.3)
...
No diff. Command name, wrapper shape and argKeys=['historyId'] byte-identical between 1.0.9 and 1.2.3 windows ipc-contracts.jsonl.
