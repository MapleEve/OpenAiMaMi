# AI Handoff — load_custom_instruction_state (windows AiMaMi 1.2.3 custom-instructions)

status: accepted_ready_absent_backend_orphan_ida_direct (migrated_no_behavior_diff)
evidence_root: raw/aimami/1.2.3/windows-x64/custom-instructions/load_custom_instruction_state/
...
scripts: tools/IDA CLI win func_query '{"queries":[{"name_regex":"load_custom_instruction_state"}]}'; tools/IDA CLI win find_regex '{"pattern":"load_custom_instruction_state"}'
