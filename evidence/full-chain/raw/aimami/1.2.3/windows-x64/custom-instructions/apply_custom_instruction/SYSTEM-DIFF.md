# System Diff — apply_custom_instruction (windows AiMaMi 1.0.9 -> 1.2.3)
...
No diff. Command name, wrapper shape and argKeys=['content', 'templateCode', 'templateTitle', 'source'] byte-identical between 1.0.9 and 1.2.3 windows ipc-contracts.jsonl.
