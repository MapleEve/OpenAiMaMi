...
// addr: 0x140cd99b0
// name: load_session_analytics
// win 1.2.1 | module src/commands/analytics.rs | attributed via panic-Location xref (win-native)
// win 1.2.1 | tauri command handler = load_session_analytics | mapped via command-name string xref (win-native, ground-truth)
char __fastcall load_session_analytics(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rbx
  __int64 v6; // rax
  __int64 v7; // rdi
...
LABEL_38:
          ...
          if ( *((_DWORD *)v50 + 4) == 2 )
          {
            ...
            v52 = v50[1] + v51;
            v165 = 0;
            v53 = sub_14089EAE0(v52, (__int64)v50, (__int64)&v80, (__int64)&off_1417642A8);
          }
          else
          {
            v54 = 704;
            ...
            v55 = v50[9] + v54;
            v165 = 0;
            v53 = sub_14089EAE0(v55, (__int64)(v50 + 8), (__int64)&v80, (__int64)&off_141764290);
          }
          v5 = v162;
...
LABEL_108:
          ...
          v149 = (_BYTE *)v15;
          v158 = v7;
          sub_1416C3420(&off_1417BB508, a2, a3, a4);
        case 3:
LABEL_22:
          v151 = v16;
