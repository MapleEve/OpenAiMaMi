...
__int64 __fastcall sub_14089D080(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r13
  ...
  _BYTE v28[172]; // [rsp+BCh] [rbp+3Ch] BYREF
  __int64 v29; // [rsp+168h] [rbp+E8h]
  volatile signed __int64 *v30; // [rsp+178h] [rbp+F8h]
  __int64 v31; // [rsp+180h] [rbp+100h]
  _QWORD v32[29]; // [rsp+208h] [rbp+188h] BYREF
