...
__int64 __fastcall sub_14089CAA0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r13
  ...
  _BYTE v30[916]; // [rsp+13Ch] [rbp+BCh] BYREF
  __int64 v31; // [rsp+4D0h] [rbp+450h]
  volatile signed __int64 *v32; // [rsp+4E0h] [rbp+460h]
  __int64 v33; // [rsp+4E8h] [rbp+468h]
  __int64 *v34; // [rsp+528h] [rbp+4A8h]
  __int64 v35; // [rsp+530h] [rbp+4B0h]
  ...
  sub_141684120((char *)v20 + 4, a3, 160);
  v22 = 204;
  v23 = nullptr;
  v24 = &off_1417BCDF8;
  v25 = 0;
  ...
  v28 = v9;
  v29 = 0;
  sub_141684120(v30, v20, 164);
  *(_OWORD *)&v30[900] = 0;
  v31 = 0;
  v32 = v12;
  v33 = v4;
  nullsub_1(v13);
  v14 = sub_140001650(1024, 128);
  if ( !v14 )
    sub_1416C2D31(128, 1024);
  v15 = v14;
  sub_141684120(v14, &v22, 1024);
  LOBYTE(v16) = 1;
