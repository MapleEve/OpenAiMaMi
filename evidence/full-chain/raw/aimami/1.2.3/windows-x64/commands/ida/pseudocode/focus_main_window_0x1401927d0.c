...
// win 1.2.1 | tauri command handler = focus_main_window | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall focus_main_window(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // r14
  __int128 v4; // kr00_16
