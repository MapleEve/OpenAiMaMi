...
// addr: 0x14017c3a0
// name: request_accessibility_permission
// win 1.2.1 | tauri command handler = request_accessibility_permission | mapped via command-name string xref (win-native, ground-truth)
