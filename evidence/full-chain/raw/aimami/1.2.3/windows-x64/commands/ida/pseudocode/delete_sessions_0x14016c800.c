...
// win 1.2.1 | tauri command handler = delete_sessions | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall delete_sessions(__int64 a1)
{
  __int64 v2; // r14
  __int64 v3; // rcx
  __int64 v4; // r14
  ...
  __int64 v28; // [rsp+5E8h] [rbp+568h] BYREF
  __m256i v29; // [rsp+5F0h] [rbp+570h]
  __int128 v30; // [rsp+670h] [rbp+5F0h] BYREF
  __int64 v31; // [rsp+680h] [rbp+600h]
  __m256i v32; // [rsp+688h] [rbp+608h] BYREF
  __m256i v33; // [rsp+6A8h] [rbp+628h] BYREF
  __int64 v34; // [rsp+6C8h] [rbp+648h]
  __int128 v35; // [rsp+6D0h] [rbp+650h] BYREF
  __int64 v36; // [rsp+6E0h] [rbp+660h]
  __int64 v37; // [rsp+6F0h] [rbp+670h]
  __int64 v38; // [rsp+6F8h] [rbp+678h]
  char v39; // [rsp+706h] [rbp+686h]
  char v40; // [rsp+707h] [rbp+687h]
  __int64 v41; // [rsp+708h] [rbp+688h]
  ...
  v23 = &v35;
  v40 = 1;
  sub_1403204C0(&v33, &v18);
  if ( v33.m256i_i8[0] == -1 )
  {
    v31 = v33.m256i_i64[3];
    v30 = *(_OWORD *)&v33.m256i_u64[1];
    v40 = 1;
    sub_1409712E0(&v25, v2, &v30);
    sub_141684120(&v18, a1 + 520, 400);
    if ( (_QWORD)v25 != -1 )
    {
      sub_141684120(&v28, &v25, 136);
LABEL_17:
      v39 = 0;
      sub_140433CE0(&v18, &v28);
      goto LABEL_18;
    }
    v4 = *((_QWORD *)&v25 + 1);
    v5 = v26;
