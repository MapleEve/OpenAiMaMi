...
// addr: 0x140184d00
// name: save_voice_processing_modes
// win 1.2.1 | tauri command handler = save_voice_processing_modes | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall save_voice_processing_modes(__int64 a1)
{
  __int64 v2; // r14
  __int64 v3; // rdx
  __int64 v4; // r8
  ...
  if ( !v2 )
  {
    ...
    if ( LOBYTE(v33[0]) != 0xFF )
    {
      ...
      *(_QWORD *)v39 = 1;
      v48 = 0;
      sub_14047E370((unsigned int)&v22, v19, (unsigned int)v39, (unsigned int)&v34, v20, v21);
      goto LABEL_18;
    }
    v2 = *((_QWORD *)&v33[0] + 1);
  }
  ...
  v27 = &v43;
  v48 = 1;
  sub_140B96320(&v29, &v22);
  if ( v29 != 1 )
  {
    v32[1] = v31;
    v32[0] = v30;
    v48 = 1;
    sub_140759990(&v34, v2, v32);
...
LABEL_10:
        v45 = v9;
        v46 = v7;
        sub_1416C2D4B(v10, *((_QWORD *)&v8 + 1));
      }
      *(_QWORD *)&v8 = v11;
      sub_141684120(v11, v9, *((_QWORD *)&v8 + 1));
      if ( !v7 )
      {
LABEL_16:
        v39[8] = 3;
