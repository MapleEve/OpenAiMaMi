...
// addr: 0x14018af90
// name: load_pending_auto_switch
// win 1.2.1 | tauri command handler = load_pending_auto_switch | mapped via command-name string xref (win-native, ground-truth)
...
LABEL_2:
    v41 = 1;
    sub_1403D1010(&v22, v2);
    sub_141684120(v25, a1 + 520, 400);
    if ( (_DWORD)v22 != -1 )
    {
      sub_141684120(&v26, &v22, 728);
LABEL_14:
      v40 = 0;
      sub_140431660(v25, &v26);
      goto LABEL_15;
    }
    v7 = v23;
    v8 = (const char *)v24;
...
LABEL_8:
      ...
      v11 = v10;
      sub_141684120(v10, *((_QWORD *)&v7 + 1), v8);
      if ( !(_QWORD)v7 )
      {
LABEL_13:
        LOBYTE(v27) = 3;
  ...
  v24 = v25[1];
  v23 = v25[0];
  sub_141684120(&v26, a1 + 520, 360);
  v33 = *(_OWORD *)(a1 + 880);
  v34 = *(_QWORD *)(a1 + 896);
  v22 = 1;
  v41 = 0;
  sub_14047E370((unsigned int)&v26, v19, (unsigned int)&v22, (unsigned int)&v33, v20, v21);
LABEL_15:
  if ( (_QWORD)v36 != -1 )
  {
    v12 = *((_QWORD *)&v36 + 1);
    ...
    while ( v38 != v39 )
    {
      ++v39;
      v13 = v12 + 96;
      sub_1402C7520(v12, v4, v5, v6, v15);
      v12 = v13;
    }
    if ( (_QWORD)v36 )
