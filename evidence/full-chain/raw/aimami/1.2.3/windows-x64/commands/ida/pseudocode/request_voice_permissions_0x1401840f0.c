...
// addr: 0x1401840f0
// name: request_voice_permissions
// win 1.2.1 | tauri command handler = request_voice_permissions | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall request_voice_permissions(__int64 a1)
{
  __int64 v2; // rcx
  __int128 v3; // kr00_16
  const char *v4; // rsi
  ...
  v32 = &v37;
  v42 = 1;
  sub_1401C3650(&v24, &v27);
  if ( v24 != -1 )
  {
    sub_141684120(v16, &v24, 152);
    v42 = 1;
    sub_140B94DE0(&v21, v16);
    sub_141684120(&v24, a1 + 520, 400);
    if ( (_DWORD)v21 != 2 )
    {
      sub_141684120(&v27, &v21, 792);
LABEL_13:
      v41 = 0;
      sub_1404353B0(&v24, &v27);
      goto LABEL_14;
    }
    v3 = v22;
    v4 = (const char *)v23;
...
LABEL_5:
      ...
      v10 = v9;
      sub_141684120(v9, *((_QWORD *)&v3 + 1), v4);
      if ( !(_QWORD)v3 )
        goto LABEL_12;
    }
    else
...
LABEL_12:
  ...
  v23 = v26;
  v22 = v25;
  sub_141684120(&v27, a1 + 520, 360);
  v34 = *(_OWORD *)(a1 + 880);
  v35 = *(_QWORD *)(a1 + 896);
  v21 = 1;
  v42 = 0;
  sub_14047E370((unsigned int)&v27, v18, (unsigned int)&v21, (unsigned int)&v34, v19, v20);
LABEL_14:
  if ( (_QWORD)v37 != -1 )
  {
    v11 = *((_QWORD *)&v37 + 1);
