...
// addr: 0x14016f6d0
// name: save_voice_llm_config
// win 1.2.1 | tauri command handler = save_voice_llm_config | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall save_voice_llm_config(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rsi
