...
// win 1.2.1 | tauri command handler = start_voice_capture | mapped via command-name string xref (win-native, ground-truth)
__int64 __fastcall start_voice_capture(__int64 a1)
{
  ...
  if ( v32 != -1 )
  {
    ...
    sub_140874EC0((__int64)&v35, (__int64)v31);
    v3 = v35;
    v4 = v36;
    v5 = v37;
    v6 = v38;
