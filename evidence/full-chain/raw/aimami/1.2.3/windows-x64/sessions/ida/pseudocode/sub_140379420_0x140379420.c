...
__int64 __fastcall sub_140379420(const __m128i *a1, _QWORD *a2)
{
  __m128i v2; // xmm0
  __int64 v3; // r9
  __int64 v4; // r8
  ...
  __int64 v27; // r8
  __int64 v28; // rdx
  char v30; // [rsp+2Fh] [rbp-59h] BYREF
  __m128i v31; // [rsp+30h] [rbp-58h] BYREF
  __m128i v32; // [rsp+40h] [rbp-48h]
  __m128i v33; // [rsp+50h] [rbp-38h]
  __int128 v34; // [rsp+60h] [rbp-28h]
  ...
  v34 = 0;
  v35 = 0;
  sub_140420970(&v31, *a2, a2[1]);
  v30 = -1;
  sub_140420970(&v31, &v30, 1);
