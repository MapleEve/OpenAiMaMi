...
void __fastcall sub_14067F030(const __m128i **a1)
{
  ...
  if ( v1 )
  {
    ...
    if ( v3 )
    {
      ...
      do
      {
        ...
        if ( v10 )
          sub_140001660(v9[-3].m128i_i64[1], v10, 1);
        v11 = v9[-2].m128i_i64[1];
        if ( v11 != -1 && v11 )
          sub_140001660(v9[-1].m128i_i64[0], v11, 1);
    ...
    v12 = 48LL * (_QWORD)v1;
    v13 = 49LL * (_QWORD)v1 + 65;
    if ( v13 )
      sub_140001660(&(*a1)[v12 / 0xFFFFFFFFFFFFFFF0uLL - 3], v13, 16);
  }
}