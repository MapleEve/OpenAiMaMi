...
char __fastcall sub_14061E4D0(_QWORD *a1, __int64 *a2, __int64 a3, __int64 a4)
{
  __int64 v6; // rax
  __int64 v7; // rax
  __int64 v8; // rcx
...
LABEL_82:
        if ( (_DWORD)v53 != -1 )
          sub_1405E1460((__int64)v70);
        v61 = v94;
        v62 = v94[4];
        v63 = *((unsigned int *)v94 + 10);
        if ( (_DWORD)v63 != 0 || v62 != 0 )
        {
          sub_1412F1530(v85, v62, v63, &off_141767C98);
...
LABEL_96:
      *((_BYTE *)v54 + 80) = result;
      return result;
    case 1LL:
      sub_1416C3400(&off_141767C80, a2, a3, a4);
    case 2LL:
      sub_1416C3420(&off_141767C80, a2, a3, a4);
    case 3LL:
      v16 = a2 + 11;
      v17 = a2[11];
      if ( v17 != -1 )
