...
_QWORD *__fastcall sub_1409CEC90(_QWORD *a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
...
LABEL_14:
  ...
  if ( v17 != 6 || *(_DWORD *)v16 ^ 0x4E4F445B | *(unsigned __int16 *)(v16 + 4) ^ 0x5D45 )
  {
    ...
    else
    {
      v23[1] = v22[1];
      v23[0] = v22[0];
      anthropic_to_responses_response_with_too((__int64)v14, a2, (__int64)v23);
      sub_1400104F0(v23);
    }
    return v14;
  }
  sub_1409CEA10(v14, a2);
  return v14;
}