...
// addr: 0x140645390  size: 0xfe  tier: C  evidence: panic-location-2hop
...
//
// Functional summary:
//   Small (0xfe) handler: switches on a discriminant byte to decide whether to construct/attach an 'ok'
//   string body, then packs a 200 OK status plus the body into the outgoing response tuple/struct
//   (fields laid out at a1+0..a1+112 matching a (StatusCode, HeaderMap-ish, Body) response triple). This
//   is the trivial health-check responder wired to /__aimami/health.
//
// Referenced strings/symbols:
//   0x1416c3400  sub_1416C3400
//   0x141769268  off_141769268
//   0x1416c3420  sub_1416C3420
//   0x141768f18  off_141768F18
//   0x140faebb0  sub_140FAEBB0
//   0x141766c30  aOk_0   "ok"
