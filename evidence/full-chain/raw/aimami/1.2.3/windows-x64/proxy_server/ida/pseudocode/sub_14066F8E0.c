...
// addr: 0x14066f8e0  size: 0x1d9  tier: C  evidence: panic-location-2hop
...
//
// Functional summary:
//   References 'relay' and 'upstream_json_decode_failed' -- constructs the structured error emitted when
//   the JSON body returned by an upstream provider fails to parse (serde_json::from_slice error path
//   surfaced back to the client with an 'upstream_json_decode_failed' error code).
//
// Referenced strings/symbols:
//   0x140678850  sub_140678850
//   0x14149c0f0  sub_14149C0F0
//   0x14177c841  unk_14177C841
//   0x14041f680  sub_14041F680
//   0x14177c861  unk_14177C861
//   0x1403565c0  sub_1403565C0
//   0x141767fac  aRelay   "relay"
//   0x14177c884  aUpstreamJsonDe   "upstream_json_decode_failed"
