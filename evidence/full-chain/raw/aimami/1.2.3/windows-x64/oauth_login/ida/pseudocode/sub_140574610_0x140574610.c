...
volatile signed __int64 *__fastcall sub_140574610(volatile signed __int64 **a1)
{
  ...
  if ( *((_QWORD *)*a1 + 3) )
  {
    ...
    if ( v2 )
    {
      ...
      result = (volatile signed __int64 *)*v3;
      if ( *v3 && !_InterlockedDecrement64(result) )
        result = (volatile signed __int64 *)sub_140573FA0(v3);
    }
  }
  if ( v4 != (volatile signed __int64 *)-1LL && !_InterlockedDecrement64(v4 + 1) )
    return (volatile signed __int64 *)sub_140001660(v4, 40, 8);
  return result;
}