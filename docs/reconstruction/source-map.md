...
| `docs/reconstruction/diagnostics-current-source-evidence-map.md` | diagnostics 后端只读快照 | `scripts/validate-backend-diagnostics-owner.mjs` 直接验证本文、diagnostics repository 只读快照、maintenance 转发、DTO owner、restored/RepositoryRead 状态和 pending 深诊断边界。 |
