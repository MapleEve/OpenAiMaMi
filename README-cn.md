...
| 前端 | 入口、Provider、路由、运行时、服务门面、缓存、i18n、E2E mock、模块 owner 和多条 current-source 收口链路已有聚合验证；具体模块进度统一放在重建文档和验证脚本中。 | 仍以全量还原为目标；不声明双平台、全叶子节点或全部文案已经 100% 完成，除非公开证据、收口记录和验证脚本都能支撑。 | `npm run validate:frontend` |
