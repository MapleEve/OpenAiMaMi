...
| 前端架构与竞态 | `validate:frontend-entry`、`validate:frontend-layer-owners`、`validate:frontend-voice-boundary`、`validate:frontend-relay-cache`、`validate:frontend-maintenance-cache`、`validate:frontend-daemon-autoswitch-cache`、`validate:frontend-plugins-cache`、`validate:frontend-mcp-cache`、`validate:frontend-analytics-sequence`、`validate:frontend-mystery-gates`、`validate:e2e-mocks` |
