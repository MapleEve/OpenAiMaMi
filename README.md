...
| 前端 | `src/` 已按入口、路由、全局 Provider、runtime initializer、模块 owner、缓存 owner、路由高 IO 反馈查询映射、i18n 和 E2E mock 建立可继续还原的主流模块化结构。 | 不声明前端已经 100% 完成，不声明 macOS / Windows 双平台 leaf 已全部闭合；完整度继续由 raw/internal、leaf 队列、源码 closeout 和验证脚本确认。 |
