...
| 后端六边形骨架 | `src-tauri/` 已建立 commands、application、core、platform、repository、adapters、contracts 的六边形边界；system、daemon/autoswitch 等后端 owner 按命令适配、用例事务、核心状态和仓储事实持续收敛。 |
