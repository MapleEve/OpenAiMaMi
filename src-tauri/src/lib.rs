...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::system::note_usage_refresh_activity,
            commands::system::schedule_full_runtime_refresh,
            commands::system::start_auto_switch_pending_watcher,
            commands::system::start_usage_refresh_watcher,
            commands::system::update_usage_refresh_schedule,
